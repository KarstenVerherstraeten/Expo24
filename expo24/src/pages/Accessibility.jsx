		...
		<>
			<div className={AccessibilityCSS.AccessibilityContainer}>
				...
				<div className={AccessibilityCSS.transport}>
					{["Trein", "Fiets", "Bus", "Auto", "Metro"].map(
						(transport, index) => (
							<div key={index} className={AccessibilityCSS.section}>
								...
								>
									<h3>{transport}</h3>
									<span
										className={`${AccessibilityCSS.arrow} ${
											openSection === transport ? AccessibilityCSS.open : ""
										}`}
									>
								...
								<div
									className={`${AccessibilityCSS.sectionContent} ${
										openSection === transport ? AccessibilityCSS.open : ""
									}`}
								>
									{openSection === transport && ( // Added condition here
										<>
											...
											{transport === "Bus" && (
												<p>
													Bus 86 stopt op 5 minuten lopen van de campus. Stap
													uit bij de halte 'Havenlaan'.
												</p>
											)}
											{transport === "Auto" && (
												<p>
											...
											{transport === "Metro" && (
												<p>
													Metrostation 'Delacroix' ligt op 10 minuten lopen van
													de campus.
												</p>
											)}
										</>
