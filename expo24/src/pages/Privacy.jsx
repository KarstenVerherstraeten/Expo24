		...
		<>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to Erasmushogeschool Brussel, Nijverheidskaai
						170, 1070 Anderlecht.
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Expo24, accessible from
						<a
							href="expo24.multimedia.brussels"
							rel="external nofollow noopener"
							target="_blank"
						>
							expo24.multimedia.brussels
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>
					...
					<a
						href="expo24.multimedia.brussels/privacy"
						rel="external nofollow noopener"
						target="_blank"
					>
						expo24.multimedia.brussels/privacy
					</a>
				</li>

                <li>
                    By email:
                    <a href="mailto:info@ehb.be?subject:= Privacy Email">info@ehb.be</a>
                </li>
			</ul>
