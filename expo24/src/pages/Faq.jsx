			...
			<div className={FaqCSS.faqContainer}>
				...
				<div className={FaqCSS.accordion}>
					{faqs.map((faq, index) => (
						<div key={index} className={FaqCSS.accordionItem}>
							<div className={FaqCSS.accordionTitle} onClick={() => handleToggle(index)}>
								<span>{faq.question}</span>
								<span className={`${FaqCSS.arrow} ${activeIndex === index ? FaqCSS.open : ""}`}>
									<span className="material-symbols-outlined">{activeIndex === index ? "expand_less" : "expand_more"}</span>
								</span>
							</div>
							<div className={`${FaqCSS.accordionContent} ${activeIndex === index ? FaqCSS.active : ""}`}>{faq.answer}</div>
						</div>
					))}
				</div>
				...
				{/* <div className={FaqCSS.socialMedia}>
					...
					<a href="https://www.tiktok.com/@multimedia.ehb/" target="_blank" rel="noopener noreferrer">
						<svg width="94" height="94" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg" className={FaqCSS.icon}>
							<path
						...
						<a href="https://www.instagram.com/erasmushogeschool/" target="_blank" rel="noopener noreferrer">
							<svg width="94" height="94" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg" className={FaqCSS.icon}>
								<path
						...
						<a href="https://www.facebook.com/erasmushogeschool" target="_blank" rel="noopener noreferrer">
							<svg width="93" height="93" viewBox="0 0 93 93" fill="none" xmlns="http://www.w3.org/2000/svg" className={FaqCSS.icon}>
								<path
						...
						<a href="https://www.linkedin.com/school/erasmushogeschool-brussel/" target="_blank" rel="noopener noreferrer">
							<svg width="86" height="86" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg" className={FaqCSS.icon}>
								<path
